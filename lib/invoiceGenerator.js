...
export async function generateInvoice(order) {
  try {
    ...
    // Enhanced browser configuration for Arabic font support
      ...
      <head>
        ...
        <style>
          @font-face {
            ...
            src: url('https://fonts.gstatic.com/s/notonaskharabic/v25/RrQKbpV-9Dd1b1OAGA6M9PkyDuVBePeKNaxcsss0Y7bwj84.woff2') format('woff2');
            font-weight: 400;
            font-style: normal;
            font-display: swap;
              ...
              <tbody>
                ${order.items
                  ...
                  <tr>
                    ...
                    <td class="${item.title.match(/[\u0600-\u06FF]/) ? 'arabic' : ''}">${item.title}</td>
                    <td style="text-align: center">${item.class}</td>
                    <td>${item.publisher}</td>
                    <td class="${item.section.match(/[\u0600-\u06FF]/) ? 'arabic' : ''}">${item.section}</td>
    ...
    // Configure page for better font rendering
