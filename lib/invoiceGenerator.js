  ...
  try {
    ...
    let browserConfig = isProd
      ? {
          ...
          executablePath: "/usr/bin/chromium-browser",  // Use the system Chromium
          headless: true,
        }
      : {
          executablePath:
    ...
    const invoiceHtml = `
      ...
      <head>
        ...
        <style>
          @font-face {
            font-family: 'Amiri';
            src: url('https://fonts.googleapis.com/css2?family=Amiri&display=swap') format('woff2');
            font-weight: normal;
            font-style: normal;
            font-display: swap;
          }
          ...
          * {
          ...
          .arabic {
            ...
            direction: rtl;
            text-align: right;
            font-feature-settings: "init" on, "medi" on, "fina" on, "rlig" on;
            -webkit-font-feature-settings: "init" on, "medi" on, "fina" on, "rlig" on;
            font-kerning: normal;
        ...
        <div class="document">
          ...
          <div class="order-meta">
            ...
            <div class="meta-item">
              ...
              <span class="meta-value">${new Date(order.createdAt).toLocaleDateString("en-US", {
                year: "numeric",
                month: "long",
                day: "numeric",
              })}</span>
              ...
              <tbody>
                ${order.items
                  ...
                  <tr>
                    ...
                    <td class="${item.title.match(/[\u0600-\u06FF]/) ? 'arabic' : ''}"
                        style="font-feature-settings: 'init' on, 'medi' on, 'fina' on, 'rlig' on;">
                        ${item.title}
                    </td>
                    <td style="text-align: center">${item.class}</td>
                    <td>${item.publisher}</td>
                    <td class="${item.section.match(/[\u0600-\u06FF]/) ? 'arabic' : ''}"
                        style="font-feature-settings: 'init' on, 'medi' on, 'fina' on, 'rlig' on;">
                        ${item.section}
                    </td>
    ...
    // Configure page content with proper font handling
    ...
    await page.evaluateHandle(() => {
      ...
      document.body.style.fontFeatureSettings = '"init" on, "medi" on, "fina" on, "rlig" on';
    });
