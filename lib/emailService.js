                ...
                <table width="100%" cellpadding="0" cellspacing="0" border="0" style="max-width: 500px;">
                  ...
                  <tr>
                    <td style="padding: 24px 0;">
                      ...
                      <table width="100%" cellpadding="0" cellspacing="0" border="0" style="background-color: #F8FAFC; border-radius: 16px; padding: 16px;">
                        <tr>
                          <td style="padding: 8px 16px;">
                            <p style="margin: 0 0 4px; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', sans-serif; font-size: 13px; color: #6B7280;">Institution</p>
                            <p style="margin: 0; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', sans-serif; font-size: 15px; color: #111827;">${order.customer.institution}</p>
                          </td>
                        </tr>
                        <tr>
                          <td style="padding: 8px 16px;">
                            <p style="margin: 0 0 4px; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', sans-serif; font-size: 13px; color: #6B7280;">Email</p>
                            <p style="margin: 0; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', sans-serif; font-size: 15px; color: #111827;">${order.customer.email}</p>
                          </td>
                        </tr>
                        <tr>
                          <td style="padding: 8px 16px;">
                            <p style="margin: 0 0 4px; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', sans-serif; font-size: 13px; color: #6B7280;">Contact Numbers</p>
                            <table width="100%" cellpadding="0" cellspacing="0" border="0">
                              <tr>
                                <td style="padding: 4px 0;">
                                  <span style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', sans-serif; font-size: 13px; color: #6B7280;">Mobile${order.customer.mobileNumber === order.customer.whatsappNumber ? " & WhatsApp" : ""}:</span>
                                  <span style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', sans-serif; font-size: 15px; color: #111827;"> ${order.customer.mobileNumber}</span>
                                </td>
                              </tr>
                              ${
                              ...
                              <tr>
                                <td style="padding: 4px 0;">
                                  <span style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', sans-serif; font-size: 13px; color: #6B7280;">WhatsApp:</span>
                                  <span style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', sans-serif; font-size: 15px; color: #111827;"> ${order.customer.whatsappNumber}</span>
                                </td>
                              </tr>
                              `
                                  : ""
...
<tr>
  <td style="padding: 20px 0;">
    ...
    <ol style="margin: 0; padding: 0 0 0 20px; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', sans-serif; font-size: 15px; line-height: 24px; color: #4B5563;">
      <li style="margin-bottom: 12px;">Take a peek at your curated order list in the attachment 📋</li>
      <li>Sit back and relax - we'll ping you when your order is ready! 🎉</li>
    </ol>
  </td>
</tr>
